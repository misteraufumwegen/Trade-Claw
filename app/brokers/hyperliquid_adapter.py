...
class HyperliquidAdapter(BrokerAdapter):
    ...
    def __init__(self, api_key: str, secret_key: str, **kwargs):
        ...
        try:
            ...
            raise AuthenticationError("Invalid Hyperliquid private key") from None
    ...
    async def authenticate(self) -> bool:
        ...
        try:
            ...
            raise AuthenticationError(f"Hyperliquid auth error: {e}") from e
    ...
    async def get_quote(self, symbol: str) -> Quote:
        ...
        try:
            ...
            raise BrokerError(f"Timeout getting quote for {symbol}") from e
        except Exception as e:
            raise BrokerError(f"Error getting quote: {e}") from e
                ...
                while True:
                    ...
                    if data.get("channel") == "l2Book":
                        ...
                        quote = Quote(
                            ...
                            bid=bid,
                            ask=ask,
                            bid_size=float(data["data"]["bids"][0][1])
                            if data["data"].get("bids")
                            else 0,
                            ask_size=float(data["data"]["asks"][0][1])
