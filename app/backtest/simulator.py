...
class BacktestResults:
    ...
    def calculate_metrics(self) -> Dict[str, Any]:
        ...
        # ROI
        roi = ((self.current_equity - self.starting_capital) / self.starting_capital * 100) if self.starting_capital > 0 else 0.0
...
class BacktestSimulator:
    ...
    def simulate_trade(self, entry_price: float, stop_loss: float, tp1: float, tp2: float,
                      direction: str = "Long", trade_id: str = "UNKNOWN", 
        ...
        if exit_scenario == 'tp1':
            ...
            exit_price = entry_price + (tp1_distance * 0.75) if direction == "Long" else entry_price - (tp1_distance * 0.75)
            r_multiple = 1.5
        else:  # sl
    ...
    def run_backtest(self, trades: List[Dict[str, Any]], 
                    only_grades: Optional[List[str]] = None) -> Dict[str, Any]:
        """
        Führt Backtest aus
        ...
        logger.info(f"Backtest complete: {trades_executed} trades executed, "
