...
class CorrelationEngine:
    ...
    def analyze(
        ...
        if not asset_prices or len(asset_prices) < 2:
            return {"error": "Need at least 2 assets", "trade_eligible": False}
        ...
        return {
            ...
            "reasoning": self._generate_reasoning(avg_correlation, threshold, high_corr, low_corr),
        }

    def _generate_reasoning(
        self, avg_corr: float, threshold: float, high_pairs: int, low_pairs: int
    ) -> str:
