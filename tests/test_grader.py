...
class TestGraderEngineScoring:
    ...
    def test_score_partial_criteria(self):
        ...
        criteria = SetupCriteria(structural_level=True, momentum=True, risk_reward=True)
        score = GraderEngine.calculate_score(criteria)
        assert score == 3
...
class TestGraderEngineSetupGrading:
    ...
    def test_position_size_calculation(self):
        ...
        pos = engine._calculate_position_size(
            entry_price=42000, stop_loss_price=40000, risk_percent=2.0, account_value=100000
        )
    ...
    def test_position_size_half_risk(self):
        ...
        engine = GraderEngine()
        pos = engine._calculate_position_size(
            entry_price=42000, stop_loss_price=40000, risk_percent=1.0, account_value=100000
        )
