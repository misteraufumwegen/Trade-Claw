...
from app.backtest import BacktestSimulator, BacktestResults
...
class TestBacktestResults:
    ...
    def test_add_winning_trade(self):
        ...
        results = BacktestResults(starting_capital=100.0)
        results.add_trade_result('TRADE_001', entry=100.0, exit=110.0, 
                                direction='Long', r_multiple=2.0, pnl_chf=10.0)
    ...
    def test_add_losing_trade(self):
        ...
        results = BacktestResults(starting_capital=100.0)
        results.add_trade_result('TRADE_001', entry=100.0, exit=95.0,
                                direction='Long', r_multiple=-1.0, pnl_chf=-5.0)
...
class TestBacktestSimulator:
    ...
    def test_run_backtest_with_custom_grades(self):
        ...
        trades = [
            {'trade_id': 'T1', 'entry': 100.0, 'stop_loss': 95.0, 'tp1': 110.0, 'tp2': 120.0, 'grade': 'A+'},
            {'trade_id': 'T2', 'entry': 100.0, 'stop_loss': 95.0, 'tp1': 110.0, 'tp2': 120.0, 'grade': 'B'},
            {'trade_id': 'T3', 'entry': 100.0, 'stop_loss': 95.0, 'tp1': 110.0, 'tp2': 120.0, 'grade': 'C'},
        ]
...
class TestRiskVault:
    ...
    def test_initialization(self):
        ...
        assert vault.stop_loss_immutable == True
        assert vault.active == True
        assert vault.halted == False
    ...
    def test_check_drawdown_safe(self):
        ...
        safe, reason, dd_pct = vault.check_drawdown(
    ...
    def test_halted_state(self):
        ...
        assert vault.is_halted() == False
        
        vault.halted = True
        vault.halt_reason = "Test halt"
        
        assert vault.is_halted() == True
...
class TestRiskEngine:
    ...
    def test_pre_trade_check_position_size_exceeds(self):
        ...
        assert details['checks']['position_size'] == False
    ...
    def test_pre_trade_check_halted(self):
        ...
        assert approved == False
        assert details['checks']['halted'] == False
